...
// Configuration commune pour tous les toasts
const commonStyles = {
...
// SVG icons pour chaque type de toast
const icons = {
...
// Création d'un objet toast avec les différentes méthodes
const toast = {
    success(message) {
